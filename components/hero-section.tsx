    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
        ...
        <p className="text-xl md:text-2xl mb-8 text-purple-100 max-w-3xl mx-auto text-pretty drop-shadow-lg">
          Has sido guiado hasta aquí por una razón. Encuentra la paz en tu día a día y dirige tu vida con propósito, en un retiro de 4 dias diseñado para tu transformación
        </p>
        {showCTA && (
          <Link href={ctaLink}>
