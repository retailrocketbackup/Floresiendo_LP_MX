...
export default async function EncuentroPage({
  ...
  const whatsappUrl = `https://wa.me/${encuentro.whatsappNumber}?text=${encodeURIComponent(encuentro.whatsappMessage)}`;
  ...
  return (
    <main className="min-h-screen bg-[#fdf8f4]">
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-8">
            ...
            <p className="text-white/80">
              ...
              el proceso que mejor se adapte a ti.
            </p>
          </div>
      ...
      {/* Final CTA */}
      <section className="py-20 px-4 bg-gradient-to-br from-[#8b2a4a] to-[#5a1a33] text-white">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
