...
const PACKAGE_CONFIG: Record<string, { id: string; name: string; amount: number }> = {
  DEPOSIT: { id: 'DEPOSIT', name: 'Anticipo - Retiro Marzo 2026', amount: 300000 },
...
export default function PreciosRetiroClean() {
  ...
  useEffect(() => {
    ...
    trackEvent(
      "ViewContent_Precios",
      {
        ...
        content_name: "retiro_marzo_precios_google",
    ...
    trackGoogleEvent("view_item_list", {
      item_list_name: "retiro_marzo_precios_google",
      value: 10200,
      currency: "MXN",
    });
  }, []);
            ...
            <div className="relative mb-20 max-w-2xl mx-auto group">
              ...
              <div className="relative bg-white rounded-3xl p-8 border border-gold/30 shadow-lg shadow-gold/10">
                ...
                <div className="text-center pt-4">
                  ...
                  <button
                    onClick={() => handlePackageSelect('DEPOSIT', 'Anticipo - Retiro Marzo 2026', 300000)}
