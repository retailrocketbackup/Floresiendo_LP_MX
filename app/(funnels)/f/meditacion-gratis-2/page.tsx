...
export default function MeditacionGratis2Page() {
  ...
  const sessionDate = "Lunes 20 de Abril";
  const sessionTime = "8:00 PM (Hora CDMX)";

  // Target date for countdown: April 20, 2026 at 8:00 PM CDMX (UTC-6)
  const eventDate = new Date("2026-04-20T20:00:00-06:00");
  ...
  useEffect(() => {
    trackEvent(
      "ViewContent_Meditacion",
      {
        ...
        content_name: "meditacion_en_vivo_landing_2",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await trackEvent(
        "Lead_Meditacion_Gratis_2",
        {
          funnel: "meditacion-gratis-2",
          content_type: "lead_magnet",
          content_name: "meditacion_en_vivo_2",
      ...
      const contactData = {
        ...
        funnel_source: "meditacion-gratis-2",
        // HubSpot context for contact creation
        hutk: hutk || undefined,
        pageUri: window.location.href,
        pageName: "Meditación Gratis 2 - Floresiendo",
      ...
      await trackEvent(
        "CompleteRegistration_Meditacion_2",
        {
          funnel: "meditacion-gratis-2",
      ...
      router.push("/f/meditacion-gratis-2/gracias");
    } catch (err) {
