...
const EVENT_DATE = "Lunes 20 de Abril 2026";
...
function generateGoogleCalendarLink() {
  ...
  // April 20, 2026, 8:00 PM - 8:30 PM Mexico City (UTC-6) = Apr 21, 2:00 AM - 2:30 AM UTC
  const startDate = "20260421T020000Z";
  const endDate = "20260421T023000Z";
...
function generateOutlookCalendarLink() {
  ...
  const startDate = "2026-04-20T20:00:00";
  const endDate = "2026-04-20T20:30:00";
...
export default function MeditacionGracias2Page() {
  useEffect(() => {
    trackEvent(
      "ViewContent",
      {
        funnel: "meditacion_gratis_2",
        content_type: "thank_you_page",
        content_name: "meditacion_gratis_2_gracias",
      },
      { enableCAPI: false }
    );
  }, []);
      ...
      <div className="max-w-2xl mx-auto px-4 py-16 md:py-24">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600">
            Te esperamos el 20 de abril para meditar juntos.
          </p>
        </div>
