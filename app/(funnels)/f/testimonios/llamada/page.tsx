...
export const metadata = {
  title: "Agenda tu Llamada | FloreSiendo México",
  description: "Agenda una llamada gratuita para conocer más sobre nuestros retiros de transformación.",
};

export default function FunnelTestimoniosLlamadaPage() {
  return (
    <main>
      <HeroSection />
      <VideoSection
