...
function generateGoogleCalendarLink() {
  ...
  // April 3, 2026, 8:00 PM - 8:30 PM Mexico City (UTC-6) = Apr 4, 2:00 AM - 2:30 AM UTC
  const startDate = "20260404T020000Z";
  const endDate = "20260404T023000Z";
...
function generateOutlookCalendarLink() {
  ...
  const startDate = "2026-04-03T20:00:00";
  const endDate = "2026-04-03T20:30:00";
      ...
      <div className="max-w-2xl mx-auto px-4 py-16 md:py-24">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600">
            Te esperamos el 3 de abril para meditar juntos.
          </p>
        </div>
