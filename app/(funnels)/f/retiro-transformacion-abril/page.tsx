// app/(funnels)/f/retiro-transformacion-abril/page.tsx
...
export const metadata: Metadata = {
  title: "Retiro de Transformación Personal — Abril 2026 | FloreSiendo",
  description:
...
export default function RetiroTransformacionAbril() {
  return (
    <main className="min-h-screen bg-warm-gray-50">
      <SiteHeader />
      <EncuentroTracking slug="abril-2026-google" />

      <FloatingWhatsApp
        phoneNumber={encuentro.whatsappNumber}
        message={encuentro.whatsappMessage}
        page="retiro-abril-google"
      ...
      {/* Video Testimonial */}
      <div id="testimonios">
        <VideoTestimonialSection funnel="encuentro_abril-2026-google" />
      </div>
