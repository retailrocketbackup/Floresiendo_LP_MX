...
import { encuentroAbril2026Clean } from "@/lib/encuentros-data-clean"
...
const PACKAGE_CONFIG: Record<string, { id: string; name: string; amount: number }> = {
  DEPOSIT: { id: 'DEPOSIT', name: 'Anticipo - Retiro Abril 2026', amount: 300000 },
...
export default function PreciosRetiroAbrilClean() {
  ...
  useEffect(() => {
    ...
    trackEvent(
      "ViewContent_Precios",
      {
        funnel: "precios-abril-google",
        content_type: "pricing",
        content_name: "retiro_abril_precios_google",
    ...
    trackGoogleEvent("view_item_list", {
      item_list_name: "retiro_abril_precios_google",
      value: 10200,
      currency: "MXN",
    });
  }, []);
  ...
  const encuentro = encuentroAbril2026Clean;
  ...
  return (
    <>
      ...
      <FloatingWhatsApp
        ...
        message="Hola, me interesa el Retiro de Transformación Personal de Abril 2026. ¿Podrías darme más información?"
        page="precios-abril-google"
        ...
        <section className="relative min-h-[55vh] flex items-center justify-center overflow-hidden pt-20">
          ...
          <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto py-20">
            ...
            <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-md px-6 py-3 rounded-full border border-white/20">
              ...
              <span className="text-sm font-semibold tracking-wide">{encuentro.spotsRemaining} lugares disponibles</span>
            </div>
          </div>
        </section>
            ...
            <div className="relative mb-20 max-w-2xl mx-auto group">
              ...
              <div className="relative bg-white rounded-3xl p-8 border border-gold/30 shadow-lg shadow-gold/10">
                ...
                <div className="text-center pt-4">
                  ...
                  <button
                    onClick={() => handlePackageSelect('DEPOSIT', 'Anticipo - Retiro Abril 2026', 300000)}
        ...
        <section className="relative py-24 px-4 overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            <TrackedWhatsAppLink
              ...
              page="retiro-abril-google-precios"
              buttonLocation="cta"
              eventName="Lead_Retiro_Abril_Google_Precios"
