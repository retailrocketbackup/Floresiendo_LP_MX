...
const WHATSAPP_MESSAGE = "Hola Ana, vi el video de Rodrigo sobre el estrés. Quiero mi lugar en el Mastermind gratuito del 19 de marzo";
  ...
  useEffect(() => {
    if (isSubmitted) {
      ...
      const msg = encodeURIComponent(
        `Hola Ana, soy ${formData.name.split(" ")[0]}. Vi el video de Rodrigo sobre el estrés. Quiero mi lugar en el Mastermind gratuito del 19 de marzo`
      );
