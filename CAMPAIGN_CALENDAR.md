...
## Phase 1: Awareness & List Building
### December 9 - December 22, 2025 (Weeks 1-2)

**Goal:** Build initial audience, test lead magnet funnel, establish pixel data

### Week 1: Dec 9-15

| Day | Date | Activity | Details |
|-----|------|----------|---------|
| Mon | Dec 9 | 🚀 Launch `/f/meditacion` ads | Budget: $5-10/day, Objective: Conversions |
| Tue | Dec 10 | Monitor & optimize | Check CTR, CPM, adjust audiences |
| Wed | Dec 11 | A/B test creatives | Test 2-3 ad variations |
| Thu | Dec 12 | Prepare meditation session | Zoom setup, Cal.com slots |
| Fri | Dec 13 | Email reminder to registrants | 24hr before meditation |
| **Sat** | **Dec 14** | **🧘 Free Meditation #1** | **7:00 PM CST - Live via Zoom** |
| Sun | Dec 15 | Alternative date (if needed) | Backup for Meditation #1 |

### Week 2: Dec 16-22

| Day | Date | Activity | Details |
|-----|------|----------|---------|
| Mon | Dec 16 | Analyze meditation attendance | No-show rate, engagement |
| Tue | Dec 17 | Follow-up email sequence | Thank attendees, nurture no-shows |
| Wed | Dec 18 | WhatsApp outreach | Personal messages to warm leads |
| Thu | Dec 19 | Review ad performance | CPA, CPL, best audiences |
| Fri | Dec 20 | Pause/reduce ads | Holiday period adjustment |
| Sat-Sun | Dec 21-22 | Holiday break | Minimal activity |

### Week 3-4: Holiday Period (Dec 23 - Jan 5)

| Period | Activity | Details |
|--------|----------|---------|
| Dec 23-25 | Pause ads | Christmas - low engagement expected |
| Dec 26-31 | Light retargeting only | $3-5/day, warm audiences |
| Jan 1-5 | Prepare TOFU launch | Final copy review, ad creatives ready |

---

## Phase 2: TOFU Funnels Launch
### January 6 - January 19, 2026 (Weeks 5-6)

**Goal:** Launch 3 TOFU funnels, generate WhatsApp leads, build video audiences

### Week 5: Jan 6-12

| Day | Date | Activity | Details |
|-----|------|----------|---------|
| **Mon** | **Jan 6** | **🚀 Launch `/f/duelo-acompanamiento`** | Budget: $10-15/day |
| Tue | Jan 7 | Monitor Duelo funnel | Check Lead_Duelo events |
| **Wed** | **Jan 8** | **🚀 Launch `/f/proposito`** | Budget: $10-15/day |
| Thu | Jan 9 | Monitor both funnels | Compare CPA, video metrics |
| Fri | Jan 10 | Prepare Meditation #2 | Update Cal.com, Zoom |
| **Sat** | **Jan 11** | **🧘 Free Meditation #2** | **7:00 PM CST - Nurture warm leads** |
| Sun | Jan 12 | Alternative date | Backup for Meditation #2 |

### Week 6: Jan 13-19

| Day | Date | Activity | Details |
|-----|------|----------|---------|
| **Mon** | **Jan 13** | **🚀 Launch `/f/estres`** | Budget: $10-15/day |
| Tue | Jan 14 | Full funnel analysis | All 3 funnels running |
| Wed | Jan 15 | WhatsApp follow-up round | Contact all new leads |
| Thu | Jan 16 | Video audience analysis | Video25%, 50%, 75%, Complete |
| Fri | Jan 17 | Budget reallocation | Increase best performer |
...
## Free Meditation Sessions Detail
